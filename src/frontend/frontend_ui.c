...
void mse_frontend_ui_init(mse_frontend_ui_state_t *state)
{
	...
	if (!g_frontend_log_callback_registered) {
		g_frontend_log_callback_registered = (DEBUG_RegisterCallback(mse_frontend_ui_capture_log, NULL) == 0) && (DEBUG_RegisterCallback(mse_frontend_terminal_log_callback, NULL) == 0);
